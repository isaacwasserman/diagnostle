...
export const diseases: DiseaseDef[] = [
  ...
  // ---- IBD ----
  {
    ...
    chiefComplaints: ["abdominal pain", "diarrhea", "weight loss"],
    organSystem: "gastrointestinal",
    severity: "moderate",
  ...
  },
  {
    ...
    chiefComplaints: ["bloody diarrhea", "abdominal pain", "urgency"],
    organSystem: "gastrointestinal",
    severity: "moderate",
  ...
  // ---- Celiac ----
  {
    id: "celiac_disease",
    name: "Celiac Disease",
    chiefComplaints: ["diarrhea", "bloating", "fatigue"],
    organSystem: "gastrointestinal",
    severity: "moderate",
    keywords: ["celiac", "celiac", "gluten intolerance"],
    patterns: [chronicInflammation],
    overrides: {
      hemoglobin: { direction: "low", range: [9.0, 11.5] },
  ...
  // ---- Upper GI ----
  {
    id: "stomach_ulcer",
    name: "Stomach Ulcer",
    chiefComplaints: ["epigastric pain", "nausea", "hematemesis"],
    organSystem: "gastrointestinal",
    severity: "moderate",
    keywords: ["stomach ulcer", "gastric ulcer", "peptic ulcer"],
    patterns: [acuteInflammation],
    overrides: {
      hemoglobin: { direction: "low", range: [8.0, 11.5] },
  ...
  },
  {
    ...
    organSystem: "gastrointestinal",
    severity: "mild",
    keywords: ["gerd", "reflux", "gastroesophageal reflux"],
    patterns: [],
    overrides: {
      crp: { direction: "high", range: [5, 15] },
      hemoglobin: { direction: "low", range: [10.5, 12.0] },
