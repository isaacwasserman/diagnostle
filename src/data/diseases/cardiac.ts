...
export const diseases: DiseaseDef[] = [
  ...
  // ---- 2. Angina ----
  {
    ...
    overrides: {
      ...
      echocardiogram: {
        value: "Regional wall motion abnormality on stress test",
      },
    },
  },
  ...
  // ---- 3. Atrial Fibrillation ----
  {
    ...
    overrides: {
      ecg: {
        value:
          "Irregularly irregular rhythm, absent P waves, fibrillatory baseline",
      },
  ...
  // ---- 5. Heart Block ----
  {
    ...
    overrides: {
      ...
      ecg: {
        value: "Prolonged PR interval / dissociated P waves and QRS complexes",
      },
  ...
  // ---- 6. Abdominal Aortic Aneurysm ----
  {
    ...
    overrides: {
      ...
      ct_abdomen: {
        value:
          "Dilated abdominal aorta >5.5 cm, possible retroperitoneal hematoma",
      },
  ...
  // ---- 8. Endocarditis ----
  {
    ...
    overrides: {
      ...
      creatinine: { direction: "high", range: [1.3, 2.5] },
      skin_exam: {
        value: "Janeway lesions, Osler nodes, splinter hemorrhages",
      },
    },
  },
  ...
  // ---- 10. Peripheral Arterial Disease ----
  {
    ...
    overrides: {
      ...
      skin_exam: {
        value: "Pallor on elevation, dependent rubor, absent pedal pulses",
      },
  ...
  // ---- 11. Supraventricular Tachycardia ----
  {
    ...
    overrides: {
      ecg: {
        value: "Narrow-complex tachycardia, absent P waves, regular rhythm",
      },
  ...
  // ---- 13. Pulmonary Hypertension ----
  {
    ...
    overrides: {
      ...
      echocardiogram: {
        value:
          "Right ventricular dilatation, elevated PASP, tricuspid regurgitation",
      },
      chest_xray: {
        value: "Enlarged pulmonary arteries, right heart enlargement",
      },
      spo2: { direction: "low", range: [85, 93] },
      ecg: {
        value:
          "Right axis deviation, right ventricular hypertrophy, P pulmonale",
      },
  ...
  // ---- 14. Deep Vein Thrombosis ----
  {
    ...
    overrides: {
      ...
      skin_exam: {
        value:
          "Unilateral leg swelling, warmth, erythema, positive Homans sign",
      },
  ...
  // ---- 15. Pulmonary Embolism ----
  {
    ...
    overrides: {
      ...
      ct_angiogram: {
        value:
          "Filling defect in pulmonary artery — pulmonary embolism confirmed",
      },
      heart_rate: { direction: "high", range: [100, 140] },
